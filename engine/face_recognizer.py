...
class FaceRecognizer:
    ...
    def is_frontal_face(
        ...
        try:
            ...
            # 3. Nose horizontal placement between eyes (with 12% width tolerance for 45-deg semi-frontal/seated)
            if nt_x < (min_eye_x - 0.12 * w) or nt_x > (max_eye_x + 0.12 * w):
